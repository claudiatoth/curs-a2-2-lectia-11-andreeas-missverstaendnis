// PDF BUILDER — A2.2 Lecția 11: Andreeas Missverständnis (Reflexive Verben mit Bedeutungsänderung)
(function () {
    ...
    function buildCast() {
        return `<div class="cast-banner">
            <h4>👋 A2.2 · Lecția 11 · Annettes Deutschkurs</h4>
            <div class="cast-grid">
                <div class="cast-card"><img src="images/andreea.png" alt="Andreea"><div class="name">Andreea 🇷🇴</div><div class="detail">Încurcă verbele</div></div>
    ...
    function buildTheory() {
        ...
        t = t.replace(/<div class="theory-box"\s+style="background:\s*#F5F0E8[^"]*"[^>]*>/g, '<div class="theory-box warn-box">');
        return `<h1 class="chapter">📘 1. Teorie — Reflexive Verben mit Bedeutungsänderung</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillPromptBlock('Übung 1 — Pronumele reflexiv (mich/mir)', 'Akkusativ: mich/dich/sich/uns/euch · Dativ: mir/dir (la vorstellen/merken/leisten).', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += choiceBlock('Übung 2 — Cu sich sau fără sich? (sensul)', 'Atenție la „sich" — schimbă complet sensul verbului.', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += fillPromptBlock('Übung 3 — Prepoziția fixă', 'sich verlassen auf · sich erinnern an · sich fürchten vor · sich treffen/verstehen mit · sich entschuldigen bei.', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillPromptBlock('Übung 4 — Completează verbul (conjugat)', 'Verbul reflexiv la forma corectă (cu pronumele reflexiv potrivit).', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += translateBlock('Übung 5 — Traducere RO → DE', 'Nu uita pronumele reflexiv (mich/mir) și prepoziția fixă.', ex5Data);
        }
        return html;
    }
        ...
        let html = `<h1 class="chapter new-section">🔁 4. Verbele reflexive — Präsens · Präteritum · Perfekt</h1>
            <div class="andreea-note">
                <div class="andreea-note-content">
                    ...
                    <div>Fiecare verb își schimbă sensul FĂRĂ sich: sich verlassen auf (te bazezi) vs verlassen (părăsești); sich umziehen (te schimbi) vs umziehen (te muți). Iar sich vorstellen cere Dativ (mir), nu Akkusativ.</div>
                </div>
            </div>`;
